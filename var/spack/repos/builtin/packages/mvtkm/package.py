...
class Mvtkm(CMakePackage, CudaPackage):
    ...
    git      = "https://gitlab.kitware.com/m-kim/vtk-m.git"

    version('1.5.0', git='https://gitlab.kitware.com/m-kim/vtk-m.git', branch='extrude-truncate')
        ...
        with working_dir('spack-build', create=True):
            ...
            if "+logging" in spec:
                if spec.satisfies('@:1.2.0') and \
                        spec['mvtkm'].version.string != 'master':
